...
q97.65 <- stats::quantile(df_log2vitis_resc$Size, probs = c(0, 0.25, 0.5, 0.75, 0.9765, 1), na.rm = TRUE)[5]
df_log2vitis_resc$high <- ifelse(df_log2vitis_resc$Size >= q97.65, 'yes', 'no')
